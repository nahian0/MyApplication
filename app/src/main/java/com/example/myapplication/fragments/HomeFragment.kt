...
import com.example.myapplication.network.InternetConnection
import com.example.myapplication.viewmodels.HomeViewModel
import com.example.myapplication.util.Constants.amount
import com.example.myapplication.util.Constants.liveData
import com.example.myapplication.util.Constants.paymentIDBkash
import com.example.myapplication.util.Constants.pd
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.bKashButton.safeClick({
            if (InternetConnection.isOnline(requireActivity())){
                if (binding.amountIdBkash.text.isNotEmpty()) {
                    amount = binding.amountIdBkash.text.toString()
                    binding.amountIdBkash.setText("")
    ...
    private fun createBkashPayment() {
        Log.e("bkash token",viewModel.grantTokenLiveData.value.toString())
